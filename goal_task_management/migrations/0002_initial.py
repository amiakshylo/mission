...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='goal',
            name='user_role',
            field=models.ManyToManyField(related_name='goals', to='user_management.userrole'),
        ),
        migrations.AddField(
            model_name='subtask',
            name='user',
        ...
        migrations.AddField(
            model_name='subtask',
            name='task',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goal_task_management.task'),
        ),
    ]
