...
class Goal(TimeStampedModel):
    ...
    goal_type = models.CharField(choices=GOAL_TYPE_CHOICES, default='N/A')
...
class GoalSuggestionLog(models.Model):
    user_profile = models.ForeignKey(
        'user_management.UserProfile', on_delete=models.CASCADE, related_name="suggestions"
    )
    goal = models.ForeignKey(
        "goal_task.Goal", on_delete=models.CASCADE, null=True, blank=True
    )
    role = models.ForeignKey('user_management.Role', on_delete=models.CASCADE, null=True, blank=True)
