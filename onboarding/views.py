...
from onboarding.serializers import UserResponseSerializer, QuestionSerializer, OnboardingProgressSerializer
...
class OnboardingViewSet(CreateModelMixin, GenericViewSet):
    ...
    def onboarding_progress(self, request):
        user_profile = self.request.user.user_profile
        onboarding_progress = OnboardingProgress.objects.get(user_profile=user_profile)
