    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('Personal', 'Personal'), ('Professional', 'Professional')], max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=50, unique=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('group', models.CharField(choices=[('Family', 'Family'), ('Professional', 'Professional'), ('Personal', 'Personal')], max_length=50)),
                ('goal', models.ManyToManyField(related_name='roles', to='user_management.predefinedgoal')),
            ],
        ),
        migrations.AddField(
            model_name='predefinedgoal',
            name='role',
            field=models.ManyToManyField(related_name='goals', to='user_management.predefinedrole'),
        ),
        migrations.CreateModel(
            name='UserGoal',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to='profile_picture/', validators=[user_management.validators.validate_profile_image])),
                ...
                ('goals', models.ManyToManyField(blank=True, to='user_management.usergoal')),
        ...
        migrations.AddField(
            model_name='usergoal',
            name='user_profile',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_goals', to='user_management.userprofile'),
        ),
        migrations.CreateModel(
            name='UserRole',
            fields=[
