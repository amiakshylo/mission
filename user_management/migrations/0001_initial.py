...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(default="Push notifications", max_length=255),
                ),
                (
                    "ai_assistant_model",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user_profile",
                    models.ManyToManyField(
                        related_name="roles", to="user_management.userprofile"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddConstraint(
            model_name="usergoal",
            constraint=models.UniqueConstraint(
                fields=("user_profile", "goal"), name="unique_user_goal"
            ),
        ),
        migrations.AddConstraint(
            model_name="usergoal",
