    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(
                    choices=[('M', 'Male'), ('F', 'Female'), ('O', 'Other'), ('PNS', 'Prefer not to say'),
                             ('NB', 'Non-binary'), ('SD', 'Prefer to self-describe')], max_length=20)),
                ('custom_gender', models.CharField(blank=True, max_length=20)),
                ('birth_date', models.DateField(null=True)),
                ('location', models.CharField(blank=True, max_length=255)),
                ('profile_picture', models.ImageField(blank=True, upload_to='profile_picture/',
                                                      validators=[user_management.validators.validate_profile_image])),
                ('notification_preferences', models.CharField(default='Push notifications', max_length=255)),
                ('ai_assistant_model', models.CharField(
                    choices=[('spouse', 'Spouse'), ('friend', 'Friend'), ('coach', 'Coach'),
                             ('therapist', 'Therapist')], max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('user_profile',
                 models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='user_missions',
                                      to='user_management.userprofile')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom_goal', models.CharField(blank=True, max_length=255)),
                ('goal_type', models.CharField(choices=[('short_term', 'Short-term'), ('long_term', 'Long-term')])),
                ('is_custom', models.BooleanField(default=False)),
                ('is_active', models.BooleanField(default=True)),
                ('goal', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                           to='goal_task.goal')),
                ('user_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='goals',
                                                   to='user_management.userprofile')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('life_sphere',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_balances',
                                   to='life_sphere.lifesphere')),
                ('user_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='balances',
                                                   to='user_management.userprofile')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_profile',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_areas',
                                   to='user_management.userprofile')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(
                    choices=[('Professional Roles', 'Professional Roles'), ('Personal Roles', 'Personal Roles'),
                             ('Self-Improvement Roles', 'Self-Improvement Roles'),
                             ('Community and Social Impact Roles', 'Community and Social Impact Roles'),
                             ('Wellness and Spiritual Roles', 'Wellness and Spiritual Roles')], max_length=50)),
                ('description', models.TextField(blank=True)),
                ('custom_title',
                 models.CharField(blank=True, default='Default Title', max_length=50, null=True, unique=True)),
                ('is_custom', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goal_task.task')),
                ('user_profile',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_tasks',
                                   to='user_management.userprofile')),
            ],
            options={
                'abstract': False,
