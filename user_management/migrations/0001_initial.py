    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('M', 'Male'), ('F', 'Female'), ('O', 'Other'), ('PNS', 'Prefer not to say'), ('NB', 'Non-binary'), ('SD', 'Prefer to self-describe')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('user_profile', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='user_missions', to='user_management.userprofile')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='balances', to='user_management.userprofile')),
            ],
        ),
        migrations.CreateModel(
            name='UserArea',
            fields=[
                ...
                ('user_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_areas', to='user_management.userprofile')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom_title', models.CharField(blank=True, default='Default Title', max_length=50, null=True, unique=True)),
                ('is_custom', models.BooleanField(default=False)),
